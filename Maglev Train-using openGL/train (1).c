...
glBegin(GL_POLYGON);
glVertex2f(-500+i-xm,50); 
glVertex2f(-500+i-xm,300);
...
glColor3f(0.258824,0.435294,0.258824);
glBegin(GL_POLYGON);
glVertex2f(-50+i-xm,50); 
glVertex2f(-50+i-xm,300);
...
glColor3f(0,0,0);
glBegin(GL_POLYGON);
glVertex2f(-560+i-xm,50); 
glVertex2f(-560+i-xm,300);
glVertex2f(-590+i-xm,300);
glVertex2f(-590+i-xm,50);
glEnd();
...
glColor3f(0,0,0);
glBegin(GL_POLYGON);
glVertex2f(-110+i-xm,50); 
glVertex2f(-110+i-xm,300);
glVertex2f(-140+i-xm,300);
glVertex2f(-140+i-xm,50);
glEnd();
...
glColor3f(0.258824,0.435294,0.258824);
glBegin(GL_POLYGON);
glVertex2f(260+i-xm,50); 
glVertex2f(260+i-xm,300);
glVertex2f(760+i-xm,300);
glVertex2f(960+i-xm,125);
glVertex2f(960+i-xm,50);
glEnd();

glColor3f(0.309804,0.184314,0.184314);
glBegin(GL_POLYGON);
glVertex2f(340+i-xm,300); 
glVertex2f(340+i-xm,310);
glVertex2f(754+i-xm,310);
glVertex2f(762+i-xm,300);
glEnd();

glColor3f(0,0,0);
glBegin(GL_POLYGON);
glVertex2f(310+i-xm,50); 
glVertex2f(310+i-xm,300);
glVertex2f(340+i-xm,300);
glVertex2f(340+i-xm,50);
glEnd();
//window

glColor3f(1.0,1.0,1.0);
glBegin(GL_POLYGON);
glVertex2f(410+i-xm,130); 
glVertex2f(410+i-xm,280);
glVertex2f(650+i-xm,280);
glVertex2f(650+i-xm,130);
glEnd();

glColor3f(1.0,1.0,1.0);
glBegin(GL_POLYGON);
glVertex2f(700+i-xm,130); 
glVertex2f(700+i-xm,280);
glVertex2f(752+i-xm,280);
glVertex2f(920+i-xm,130);
glEnd();
...
// glVertex2f(410+i-xm,225);
// glVertex2f(410+i-xm,125);
// glEnd();
